...
from system_tests.fixtures.common_set import URL_RESET, URL_MESSAGES, URL_CREATE,\
    URL_MSG_SEND, invite_user_channel, URL_INVITE, URL_MSG_REACT, URL_MSG_UNREACT
...
def test_invalid_message_id():
    '''Test invalid message id string passed'''
    # reset workspace
    requests.post(URL_RESET)
    ...
    response = requests.post(URL_MSG_UNREACT, json={"token": token_0, "message_id": "NOT_VALID_ID",\
        "message": "new_msg_1(1)"})
