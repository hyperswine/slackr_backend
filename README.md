# IMPORTANT Attention please marker
## Running pytest & import errors
In order to run pytest you **need** the src directory to be in sys.path.
Please run
`export PYTHONPATH=$PYTHONPATH:[directory_of_project]/src`
otherwise you will get import errors!

**Please also run by cd into the system_test or integration_tests folders! If you don't you will get
name collisions**
