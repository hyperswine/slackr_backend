...
def test_basic():
    ...
    # edit some messages
    requests.delete(URL_MSG_REMOVE, json={"token": token_0, "message_id": msg1_1})
    requests.delete(URL_MSG_REMOVE, json={"token": token_0, "message_id": msg2_1})
    requests.delete(URL_MSG_REMOVE, json={"token": token_1, "message_id": msg2_2})
...
def test_invalid_token():
    ...
    response = requests.delete(URL_MSG_REMOVE, json={"token": "NOT_VALID_TOKEN", \
        "message_id": msg1_1})
    assert response.status_code == 400 or response.status_code == 500

def test_invalid_message_id():
    '''
    Invalid message id passed - is string
    '''
    # reset workspace
    requests.post(URL_RESET)
    ...
    response = requests.delete(URL_MSG_REMOVE, json={"token": token_0, "message_id": \
        "NOT_VALID_ID"})
    assert response.status_code == 400 or response.status_code == 500
...
def test_user_not_authorised():
    ...
    response = requests.delete(URL_MSG_REMOVE, json={"token": token_1, "message_id": msg1_1})
